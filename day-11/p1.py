...
# df2=pd.read_csv("treatments.csv")
# df3=pd.read_csv("billing.csv")
# df4=pd.read_csv("vitals.csv")
# df12=pd.merge(df1,df2,on="PatientID")
# df123=pd.merge(df12,df3,on="PatientID")
# dfm=pd.merge(df123,df4,on="PatientID")
# dfm=dfm.drop_duplicates(subset="PatientID")
# print("Complete Hospital Report")
# print(dfm.to_string(header=False,index=False))
# print()
# print("Missing Values")
# print(dfm.isnull().to_string(index=False,header=False))
# print()
# print("Recovered Dataset")
# dfm=dfm.fillna(dfm["TotalBill"].mean())
# print(dfm.loc[:,["PatientID","PatientName","Department","Age","TotalBill","BloodPressure"]].to_string(index=False,header=False))
# print()
# print("Monthly Hospital Revenue")
# dfm["AdmissionDate"]=pd.to_datetime(dfm["AdmissionDate"])
# dfm.set_index("AdmissionDate",inplace=True)
# monthly_rev=dfm.resample("M")["TotalBill"].sum().round(2)
# monthly_rev.index=monthly_rev.index.strftime("%Y-%m")
# print(monthly_rev.to_string(header=False))
# print()
# print("Department Revenue")
# dep=dfm.groupby("Department")["TotalBill"].sum().round(2)
# print(dep.to_string(header=False))
# print()
# print("Department Revenue Pivot Table")
# print()
# dfm["OrderDate"]=dfm.index.strftime("%Y-%m")

# table=dfm.pivot_table(
#     values="TotalBill",
#     index="Department",
#     columns="OrderDate",
#     aggfunc='sum',
...
# longformat=pd.melt(dfm,
# id_vars=["PatientID","PatientName"],
# value_vars=["ConsultationCost","LabCost","PharmacyCost"],
# var_name="Treatment",
# value_name="Cost")
# print(longformat.to_string(header=False,index=False))
# print()
# print("Treatment Long Format")
# print()
# print("Reconstructed Treatment Dataset")
# print()
# reconstructed = longformat.pivot(
