...
mdf=pd.merge(df1,df2,on="EmployeeID")
print("Merged Employee Project Dataset")
print(mdf.to_string(index=False,header=False))
print()
print("Development Employees")
de=mdf.loc[mdf["Department"]=="Development"]
print(de.to_string(index=False,header=False))
print()
print("Average Project Duration Department Wise")
apd=mdf.groupby("Department")["Duration"].mean()
print(apd.to_string(header=False))
